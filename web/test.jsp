...
<div class="container-fluid">
        ...
        <c:forEach var="product" items="${requestScope.UP_RESULT}">
            <c:if test="${product.productID eq param.txtProID}">
                    <form action="MainController" method="POST" enctype="multipart/form-data">
                    
                     <div class="mb-3">
  <label for="txtProID" class="form-label" >ID: </label>
  <input type="hidden" name="txtProID" value="${product.productID}" class="form-control"  readonly="" placeholder="Please input in the format of pxxx" onblur="validateProductID(this)">
  <p class="form-control" >${product.productID}</p>
</div>
<div class="mb-3">
  <label for="txtProName" class="form-label">Name:</label>
    <input type="text" name="txtProname" value="${product.proName}"  class="form-control" placeholder="Please input between 2 to 100 characters" onblur="validateProductName(this)">
</div>
 <div class="mb-3">
                                <label for="txtProDes" class="form-label">Description:</label>
                               <input type="text" name="txtProdes" value="${product.description}"  class="form-control" placeholder="Please input between 2 to 200 characters" onblur="validateDescription(this)">
                            </div>
                <div class="mb-3">
                                <label for="txtPrice" class="form-label">Price:</label>
                                <input type="number" name="txtPrice" value="${product.price}"  placeholder="Please input in range 1 to 250" min="1" max="250" class="form-control" onblur="validatePrice(this)">
                            </div>
                  <div class="mb-3">
                                <label for="txtYearPublish" class="form-label">Year publish:</label>
                                <input type="number" name="txtYearPublish" value="${product.yearPublish}"  placeholder="Please input in range 2000 to 2023" min="2000" max="2023" class="form-control" onblur="validateYearPublish(this)">
                            </div>
                   
                   
                    
                    <input type="file" name="pic" placeholder="Put image here"/><br/><br/>
                    <div class="modal-footer border-0">
                    <input type="submit" name="btAction" value="UpdateProduct" class="btn btn-primary btn-block"/>
                    </div>
