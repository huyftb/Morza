                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="banner-image p-0 mt-n4 mx-n4 position-relative" >
                            ...
                            <img src="img/banner/milk.jpg"  width="100%" height="400px">
                        </div>
                        <div class="mt-n5 bg-white p-3 mb-4 rounded shadow position-relative">
                            <div class="osahan-single-top-info d-flex">
                                <img src="img/milk/milkSuper.jpg" class="img-fluid border p-2 mb-auto rounded brand-logo shadow-sm" width="100px" height="100px">
                                <div class="ml-3">
                                    <h3 class="mb-0 font-weight-bold">Milk Category</h3>
<!--                                    <div class="restaurant-detail mt-2 mb-3">
                                    ...
                                    <p class="text-muted p-0 mt-2 mb-2">This category includes some types of milk</p>
                                    <p class="mb-0 small">
                        ...
                        <c:if test="${not empty requestScope.MILK_CATE}" >
                            <div class="row">
                                <c:forEach var="img" items="${requestScope.MILK_CATE}">
