...
<!--                        <div class="buttons">
                    ...
                    <div class="card p-3">
                      ...
                      <div class="user d-flex flex-row align-items-center">
                        ...
                        <span><small class="font-weight-bold text-primary">james_olesenn</small> <small class="font-weight-bold">Hmm, I feel the foods are fresh</small></span>
                    ...
                    <div class="card p-3 mt-2">
                      ...
                      <div class="user d-flex flex-row align-items-center">
                        ...
                        <span><small class="font-weight-bold text-primary">olan_sams</small> <small class="font-weight-bold">Loving this taste! </small></span>
                    ...
                    <div class="card p-3 mt-2">
                      ...
                      <div class="user d-flex flex-row align-items-center">
                        ...
                        <span><small class="font-weight-bold text-primary">rashida_jones</small> <small class="font-weight-bold">Really cool </small></span>
                    ...
                    <div class="card p-3 mt-2">
                      ...
                      <div class="user d-flex flex-row align-items-center">
                        ...
                        <span><small class="font-weight-bold text-primary">simona_rnasi</small> <small class="font-weight-bold text-primary">@macky_lones</small> <small class="font-weight-bold text-primary">@rashida_jones</small> <small class="font-weight-bold">Delicious! </small></span>
