...
<a href="viewCart.jsp" class="btn btn-danger" data-toggle="modal" data-target="#cartModal"><i class="mdi mdi-shopping-outline"></i></a>
</div>
</nav>
  ...
  <!--<div class="product-container">-->
    ...
    <c:forEach var="result" items="${requestScope.PRO_RESULT}" varStatus="counter">
      ...
      <form action="MainController">
           <div class="col">
          <div class="card">
          <a href="ProductDetailController?pid=${result.productID}">
          <!--<img src="data:image/png;base64,${result.base64ImageData}" width="418px" height="279px"/>-->
           <img src="data:image/jpg    ;base64,${result.base64ImageData}" class="card-img-top" alt="" width="418px" height="279px"/>
          <div class="card-body">
         <div class="d-flex justify-content-between mb-2 ">
             <p class="medium mb-3"><a href="#!" class="text-muted">Category: ${result.catgoryName}</a></p>
            <!--<p class="small text-danger"><s>$10000</s></p>-->
           
          </div>
           <div class="d-flex justify-content-between mb-3">
                <h5 class="mb-0">${result.proName}</h5>
                <p class="small mb-2"><h5 class="badge badge-light ml-auto"><i class='fas fa-dollar-sign'></i> ${result.price}</h5>
              </div>
               <div class="d-flex justify-content-between mb-2">
                <p class="text-muted mb-0">Year of production: <span class="fw-bold">${result.yearPublish}</span></p>
