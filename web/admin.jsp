                                ...
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                         ...
                                         <!--<a href="MainController?btAction=create" class="btn btn-primary"><span>Create Product</span></a>-->
                                    </div>
                                </div>
                                <div>
                                            ...
                                            <form action="MainController">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> <input type="submit" value="Ban Account" name="btAction" /></td>
<!--                                                        <td>

                                                            <input type="submit" value="Delete Account" name="btAction" />
