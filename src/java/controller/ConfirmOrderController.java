...
public class ConfirmOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
           ...
           String url ="HistoryOrderController"+"?username="+username;
        ...
        try {
            ...
            result = dao.confirmOrder(orderID);
             if (result) {
               ...
               url = "HistoryOrderController"+"?username="+username;
...
//            ex.printStackTrace();
            log("ConfirmServlet _ SQL _ " + ex.getMessage());
        } catch (NamingException ex) {
//            ex.printStackTrace();
            log("ConfirmServlet _ Naming _ " + ex.getMessage()); 
        } finally {
