 ...
 * @author DELL
 */
@WebServlet(name = "GetAccInfoController", urlPatterns = {"/GetAccInfoController"})
public class GetAccInfoController extends HttpServlet {
...
//                CustomerDTO customer = new CustomerDTO(username, password, phoneNum, address, custName, email);
             ...
             log("GetAccInforServlet _ Naming _ " + ex.getMessage());
        } catch (SQLException ex) {
            log("GetAccInforServlet _ SQL _ " + ex.getMessage());
        } finally {
